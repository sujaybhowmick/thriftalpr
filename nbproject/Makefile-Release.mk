...
${OBJECTDIR}/AlprService.o: AlprService.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/AlprService.o AlprService.cpp

${OBJECTDIR}/AlprService_server.o: AlprService_server.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/AlprService_server.o AlprService_server.cpp

${OBJECTDIR}/thriftalpr_constants.o: thriftalpr_constants.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/thriftalpr_constants.o thriftalpr_constants.cpp

${OBJECTDIR}/thriftalpr_types.o: thriftalpr_types.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/thriftalpr_types.o thriftalpr_types.cpp
